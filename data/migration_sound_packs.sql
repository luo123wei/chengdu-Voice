...
(
  ...
  $t$<p>Thirteen recordings of real Sichuan dialect in the wild: Ba Shi, Lang Ge, a flight attendant switching mid-announcement, grandparents teaching Mandarin, and the famous accent fail. Each track is 30 seconds, MP3 320kbps, instant download.</p>$t$,
  3.99, 'digital', 'digital',
  '["https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=two%20overlapping%20speech%20bubbles%20with%20radiating%20sound%20wave%20lines%2C%20minimalist%20flat%20vector%20album%20cover%20art%2C%20cream%20paper%20background%2C%20black%20ink%20brush%20illustration%2C%20single%20vermillion%20red%20accent%2C%20Chinese%20craft%20aesthetic%2C%20no%20text%2C%20no%20letters%2C%20clean%20composition&image_size=square_hd"]'::jsonb,
  9999, 0, 0,
  '["digital","audio","sichuan-dialect","chengdu","language","field-recording"]'::jsonb,
...
(
  ...
  '["https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=steaming%20gaiwan%20tea%20cup%20beside%20a%20bubbling%20hotpot%2C%20rising%20steam%20curls%2C%20minimalist%20flat%20vector%20album%20cover%20art%2C%20cream%20paper%20background%2C%20black%20ink%20brush%20illustration%2C%20single%20vermillion%20red%20accent%2C%20Chinese%20craft%20aesthetic%2C%20no%20text%2C%20no%20letters%2C%20clean%20composition&image_size=square_hd"]'::jsonb,
  9999, 0, 0,
  '["digital","audio","teahouse","hotpot","chengdu","food","field-recording"]'::jsonb,
...
(
  ...
  $t$<p>Eleven recordings of ordinary life in Chengdu: the morning vegetable market, haggling at a shop, a chatty clinic doctor, a blind date where the girl pulls his ear, and the phrase that sends everyone to bed. Each track is 30 seconds, MP3 320kbps, instant download.</p>$t$,
  3.99, 'digital', 'digital',
  '["https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=bicycle%20loaded%20with%20vegetables%20and%20a%20bamboo%20basket%20at%20a%20morning%20market%2C%20minimalist%20flat%20vector%20album%20cover%20art%2C%20cream%20paper%20background%2C%20black%20ink%20brush%20illustration%2C%20single%20vermillion%20red%20accent%2C%20Chinese%20craft%20aesthetic%2C%20no%20text%2C%20no%20letters%2C%20clean%20composition&image_size=square_hd"]'::jsonb,
  9999, 0, 0,
  '["digital","audio","chengdu","daily-life","culture","field-recording"]'::jsonb,
...
(
  ...
  $t$<p>Five recordings of the city itself: rain on the Wide and Narrow Alleys, hand-rubbed mahjong tiles, automatic tile shuffling, the subway running under an ancient city, and the local art of doing things later. Each track is 30 seconds, MP3 320kbps, instant download.</p>$t$,
  2.99, 'digital', 'digital',
  '["https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=rain%20falling%20over%20old%20chinese%20tiled%20rooftops%20in%20a%20narrow%20alley%2C%20minimalist%20flat%20vector%20album%20cover%20art%2C%20cream%20paper%20background%2C%20black%20ink%20brush%20illustration%2C%20single%20vermillion%20red%20accent%2C%20Chinese%20craft%20aesthetic%2C%20no%20text%2C%20no%20letters%2C%20clean%20composition&image_size=square_hd"]'::jsonb,
  9999, 0, 0,
  '["digital","audio","soundscapes","rain","mahjong","chengdu","field-recording"]'::jsonb,
